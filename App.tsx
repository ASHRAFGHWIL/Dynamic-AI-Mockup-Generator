...
const SCENARIO_OPTIONS: ScenarioOption[] = [
  ...
  {
    id: Scenario.WOMAN_HALL_PRODUCT_CAMBRIDGE_ITALIANATE,
    title: 'Woman with Product (Cambridge Hall)',
    description: 'An elegant American woman in a trendy Italianate hall in Cambridge, sitting on a plush velvet armchair and showing awe and amazement towards your product.',
