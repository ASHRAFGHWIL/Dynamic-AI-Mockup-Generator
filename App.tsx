...
const PROMPTS = {
  base: {
    ...
    [Scenario.HALL_FRAME]: 'Architectural photograph of a long, elegant hallway in a modern home. Multiple frames are arranged in a gallery wall style. One of the frames, centrally located, is a simple black frame with a solid, vibrant magenta color (#FF00FF) placeholder inside. The hallway is well-lit with recessed lighting. 4K, hyper-realistic, clean lines.',
    [Scenario.LIBRARY_FRAME]: 'Photograph of a classic, cozy home library with floor-to-ceiling dark wood bookshelves filled with books. There is a comfortable leather armchair and a reading lamp. On the wall, among the shelves, hangs a medium-sized, antique-style frame with a solid, vibrant magenta (#FF00FF) placeholder. The lighting is warm and atmospheric. 4K, hyper-realistic.',
    [Scenario.MINIMALIST_DESK_FRAME]: 'A clean, minimalist home office scene. A sleek wooden desk is placed against a plain white wall. On the desk, leaning against the wall, is a simple, thin-bezel frame. The inside of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. The setup includes a modern laptop, a small plant, and a stylish pen holder. Natural light from the side. 4K, hyper-realistic.',
    [Scenario.CREATIVE_STUDIO_FRAME]: 'Photograph of a bright, airy artist\'s studio. The room has white brick walls and large windows. In the center, an easel holds a large canvas frame. The canvas area is a solid, vibrant magenta color (#FF00FF) placeholder. The studio is filled with art supplies like paints, brushes, and canvases. The lighting is bright and inspiring. 4K, hyper-realistic.',
    [Scenario.OUTDOOR_CAFE_FRAME]: 'DSLR lifestyle photograph. A person is sitting at a stylish outdoor cafe, holding a medium-sized, simple white frame. The inside of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. The background shows a blurred city street scene with warm afternoon light. Shallow depth of field, focusing on the person and the frame. 4K, hyper-realistic.',
    [Scenario.CORPORATE_BOARDROOM_FRAME]: 'Professional photograph of a modern, executive corporate boardroom. A long, polished table is surrounded by sleek chairs. On the main wall, there is a large, minimalist frame. The inside of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. The room is well-lit with cool, professional lighting. 4K, hyper-realistic.',
    [Scenario.LUXURY_HOTEL_LOBBY_FRAME]: 'Photograph of an opulent, five-star hotel lobby. The decor is luxurious with marble floors and grand chandeliers. On a prominent wall, a very large, ornate golden frame is hanging. The inside of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. The atmosphere is exclusive and high-end. 4K, hyper-realistic.',
    [Scenario.MODERN_OFFICE_RECEPTION_FRAME]: 'A bright, welcoming reception area of a modern tech company. Behind the sleek reception desk, on a clean feature wall, hangs an elegant frame. The placeholder area inside the frame is a solid, vibrant magenta color (#FF00FF). The company logo is subtly visible elsewhere. The lighting is bright and contemporary. 4K, hyper-realistic.',
    [Scenario.ARCHITECTS_OFFICE_FRAME]: 'An inspiring, creative architect\'s office. Blueprints and models are on a large work table. On a concrete wall, a simple, industrial-style metal frame is hanging. The placeholder area is a solid, vibrant magenta color (#FF00FF). The scene is lit with a combination of natural and task lighting. 4K, hyper-realistic.',
    [Scenario.RESTAURANT_WALL_FRAME]: 'Photograph of a trendy, upscale bistro. The interior has a cozy, intimate ambiance with warm lighting. A medium-sized frame hangs on an exposed brick wall. The placeholder area is a solid, vibrant magenta color (#FF00FF). The restaurant is bustling with blurred figures in the background. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_ZURICH]: 'Fashion editorial photograph. An elegant, stylish woman stands on Bahnhofstrasse in Zurich, with luxury storefronts blurred in the background. She is holding a large, chic, minimalist frame. The inside of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. Bright, natural daylight. 4K, hyper-realistic, sharp focus.',
    [Scenario.WOMAN_FRAME_GENEVA]: 'Travel lifestyle photograph. An elegant woman stands by Lake Geneva, with the Jet d\'Eau visible in the background. She holds a medium-sized, classic wooden frame. The placeholder area inside is a solid, vibrant magenta color (#FF00FF). The scene is bright and scenic. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_ZERMATT]: 'Picturesque photograph. A chic woman in stylish winter wear stands in the charming, car-free village of Zermatt, with the Matterhorn in the distant background. She holds a rustic wooden frame. The placeholder area is a solid, vibrant magenta color (#FF00FF). Crisp alpine light. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_BERN]: 'Historic and stylish photograph. A chic woman stands in the UNESCO World Heritage Old Town of Bern, with its characteristic arcades. She holds a vintage-style frame. The placeholder is a solid, vibrant magenta color (#FF00FF). Warm, golden hour lighting. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_LUCERNE]: 'Romantic photograph. An elegant woman stands near the iconic Chapel Bridge in Lucerne. She holds a beautiful, ornate frame. The placeholder is a solid, vibrant magenta color (#FF00FF). The scene is idyllic and charming. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_LUGANO]: 'Vibrant, Mediterranean-style photograph. A stylish woman stands on the lakeside promenade of Lugano, with palm trees and the lake in the background. She holds a modern, colorful frame. The placeholder is a solid, vibrant magenta color (#FF00FF). Bright, sunny day. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_ST_MORITZ]: 'Luxury lifestyle photograph. A glamorous woman in haute couture stands in the luxurious alpine resort of St. Moritz. She holds a high-end, designer frame. The placeholder is a solid, vibrant magenta color (#FF00FF). The scene is exclusive and sophisticated. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_INTERLAKEN]: 'Adventurous and scenic photograph. A woman in stylish outdoor gear holds a simple, natural wood frame against the stunning backdrop of Interlaken\'s lakes and mountains. The placeholder is a solid, vibrant magenta color (#FF00FF). Clear, bright daylight. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_MONTREUX]: 'Artistic photograph. An artistic woman stands on the chic lakeside promenade of Montreux, famous for its jazz festival. She holds a creative, unconventional frame. The placeholder is a solid, vibrant magenta color (#FF00FF). Soft, diffused light. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_CAIRO_MURALS]: 'Vibrant street style photograph. An elegant American woman stands on a colorful street in Cairo. She holds a large, creative frame. The placeholder inside is a solid, vibrant magenta color (#FF00FF). In the background, world-class, artistic murals are visible on the walls. The scene is full of life and color. 4K, hyper-realistic.',
    [Scenario.WOMAN_FRAME_ROME_MURALS]: 'Cinematic street photograph. An elegant Italian woman stands on a historic street in Rome. She holds a classic, ornate frame. The placeholder inside is a solid, vibrant magenta color (#FF00FF). The background features stunning, large-scale modern murals contrasting with the ancient architecture. Golden hour light. 4K, hyper-realistic.',
    [Scenario.ARMCHAIR_CHANDELIER]: 'DSLR photograph, interior design magazine style. An elegant woman in a luxurious, classic living room is looking up and pointing towards the ceiling. The ceiling is high and ornate. Centered in the ceiling is a solid, vibrant magenta color (#FF00FF) shape, acting as a clear placeholder for a chandelier. The room is well-lit and sophisticated. 4K, hyper-realistic.',
    [Scenario.GALLERY_CHANDELIER]: 'Architectural photograph of a minimalist, modern art gallery with high white walls and concrete floors. The space is empty except for a few abstract sculptures. Hanging from the center of the high ceiling is a solid, vibrant magenta color (#FF00FF) placeholder for a large, sculptural chandelier. The lighting is bright and even. 4K, hyper-realistic.',
    [Scenario.GOTHIC_CHANDELIER]: 'Atmospheric photograph of a grand hall in a Gothic manor. The hall has stone walls, vaulted ceilings, and large, arched windows. A solid, vibrant magenta color (#FF00FF) placeholder for a large, wrought-iron chandelier hangs from the ceiling. The mood is dramatic and moody, with shadows and shafts of light. 4K, hyper-realistic.',
    [Scenario.PATIO_CHANDELIER]: 'Cozy, lifestyle photograph of a bohemian-style outdoor patio at dusk. String lights are draped around the space. Hanging from the center of a wooden pergola is a solid, vibrant magenta color (#FF00FF) placeholder for a rustic or modern chandelier. The atmosphere is warm and inviting. 4K, hyper-realistic.',
    [Scenario.MODERN_DINING_CHANDELIER]: 'Minimalist interior design photograph. A sleek, modern dining room with a long wooden table and simple chairs. The walls are a neutral color. Hanging directly above the table is a placeholder for a contemporary light fixture, represented by a solid, vibrant magenta color (#FF00FF) shape. Natural light from a large window. 4K, hyper-realistic.',
    [Scenario.HOTEL_LOBBY_CHANDELIER]: 'Photograph of a grand, opulent hotel lobby with high ceilings and marble columns. In the center of the ceiling, a large, circular placeholder in solid, vibrant magenta (#FF00FF) marks the spot for a statement chandelier. The scene is luxurious and impressive. 4K, hyper-realistic.',
    [Scenario.FARMHOUSE_CHANDELIER]: 'Charming photograph of a rustic farmhouse dining area. The room features exposed wooden beams on the ceiling and a large, rustic dining table. A placeholder for a chandelier, colored in solid, vibrant magenta (#FF00FF), hangs from a central beam. The scene is cozy and full of character. 4K, hyper-realistic.',
    [Scenario.GRAND_STAIRCASE_CHANDELIER]: 'Luxurious photograph of a grand foyer in a mansion. A sweeping, elegant staircase winds its way up. In the double-height space above the staircase, a large placeholder in solid, vibrant magenta (#FF00FF) hangs, indicating where a magnificent chandelier should be. 4K, hyper-realistic.',
    [Scenario.BANQUET_HALL_CHANDELIER]: 'Photograph of a formal banquet hall, set for a gala event with round tables and elegant place settings. The hall has very high ceilings. Multiple placeholders for grand chandeliers, all in solid, vibrant magenta (#FF00FF), are distributed across the ceiling. 4K, hyper-realistic.',
    [Scenario.MUSEUM_ATRIUM_CHANDELIER]: 'Photograph of a modern museum atrium with bright, open spaces and minimalist architecture. A large, sculptural placeholder in solid, vibrant magenta (#FF00FF) hangs from the ceiling as a centerpiece. The scene is clean, bright, and contemporary. 4K, hyper-realistic.',
    [Scenario.OPERA_HOUSE_LOBBY_CHANDELIER]: 'Photograph of an opulent, historic opera house lobby with red carpets, gold leaf details, and velvet curtains. A massive, multi-tiered placeholder for a classic crystal chandelier hangs from the ornate ceiling, colored in solid, vibrant magenta (#FF00FF). 4K, hyper-realistic.',
    [Scenario.PENTHOUSE_SUITE_CHANDELIER]: 'Photograph of a luxurious penthouse suite with floor-to-ceiling windows showing a stunning city skyline at night. A placeholder for a contemporary, artistic chandelier hangs from the ceiling, colored in solid, vibrant magenta (#FF00FF). The mood is sophisticated and modern. 4K, hyper-realistic.',
    [Scenario.PRODUCT_SHELF]: 'Commercial product photograph. A single, clean, minimalist product stands on a brightly lit retail shelf. The product is a simple, matte white box with a large, solid, vibrant magenta color (#FF00FF) area on its front face, serving as a placeholder for a design. The background is a clean, white, modern store interior. The focus is sharp on the product. 4K, hyper-realistic.',
    ...
    [Scenario.COFFEE_MUG]: 'Lifestyle photograph of a person holding a simple, white ceramic coffee mug. The front of the mug has a large, solid, vibrant magenta color (#FF00FF) area as a placeholder for a design. The background is a cozy, blurred cafe setting. The focus is sharp on the mug. 4K, hyper-realistic.',
    [Scenario.COSMETIC_JAR]: 'Luxury product photograph. A premium, minimalist cosmetic jar sits on an elegant marble surface. The label area on the jar is a solid, vibrant magenta color (#FF00FF) placeholder. The lighting is soft and sophisticated, creating subtle reflections. 4K, hyper-realistic.',
    [Scenario.BOOK_COVER]: 'Photograph of a realistic hardcover book lying on a cozy wooden table, next to a pair of glasses and a cup of tea. The front cover of the book is a solid, vibrant magenta color (#FF00FF) placeholder. The scene is warm and inviting. 4K, hyper-realistic.',
    [Scenario.WINE_BOTTLE]: 'Commercial photograph of a classic wine bottle against a dark, moody background. The label on the bottle is a solid, vibrant magenta color (#FF00FF) placeholder. There are subtle highlights on the glass, giving it a premium look. 4K, hyper-realistic.',
    [Scenario.SHOPPING_BAG]: 'Fashion lifestyle photograph. A stylish person is holding a high-end paper shopping bag. The side of the bag facing the camera is a solid, vibrant magenta color (#FF00FF) placeholder. The background is a blurred, upscale retail environment. 4K, hyper-realistic.',
    [Scenario.SODA_CAN]: 'Commercial product shot of a cold, condensation-covered aluminum soda can. The label area wrapping around the can is a solid, vibrant magenta color (#FF00FF) placeholder. The background is clean and simple, making the can pop. 4K, hyper-realistic.',
    ...
    [Scenario.PILL_BOTTLE]: 'Clean, clinical photograph of a pharmaceutical pill bottle on a plain white surface. The label on the bottle is a solid, vibrant magenta color (#FF00FF) placeholder. The lighting is bright and even, suitable for medical or health products. 4K, hyper-realistic.',
    [Scenario.CEREAL_BOX]: 'Commercial photograph of a cereal box on a sunny kitchen counter, next to a bowl and a glass of milk. The front of the cereal box is a solid, vibrant magenta color (#FF00FF) placeholder. The scene is bright and cheerful. 4K, hyper-realistic.',
    ...
    [Scenario.TSHIRT_MODEL]: 'Close-up studio photograph of a person\'s torso wearing a plain, high-quality t-shirt. The chest area of the t-shirt features a solid, vibrant magenta color (#FF00FF) placeholder. The lighting is clean and professional. 4K, hyper-realistic, tack-sharp focus on the fabric and placeholder area.',
    [Scenario.HOODIE_MODEL]: 'Close-up, high-fashion streetwear photograph focusing on the torso of a model wearing a plain, stylish hoodie in an urban environment. The front of the hoodie has a solid, vibrant magenta color (#FF00FF) placeholder. The background is a slightly blurred city wall. 4K, hyper-realistic, tack-sharp focus on the hoodie\'s texture and placeholder area.',
    [Scenario.SWEATSHIRT_HANGER]: 'Close-up, minimalist product photograph of a plain sweatshirt on a wooden hanger against a clean, textured concrete wall. The center of the sweatshirt has a solid, vibrant magenta color (#FF00FF) placeholder. The lighting is soft and even. 4K, hyper-realistic, tack-sharp focus on the fabric texture.',
    [Scenario.TOTE_BAG_LIFESTYLE]: 'Close-up lifestyle photograph focusing on a person carrying a plain canvas tote bag. The side of the bag facing the camera is a solid, vibrant magenta color (#FF00FF) placeholder. The background is a bright, slightly blurred outdoor market. 4K, hyper-realistic, tack-sharp focus on the tote bag\'s texture and placeholder area.',
    [Scenario.BASEBALL_CAP_MODEL]: 'Close-up, high-fashion portrait of a person wearing a plain baseball cap. The person is looking slightly away from the camera. The front of the cap has a solid, vibrant magenta color (#FF00FF) placeholder. The focus is entirely on the cap. 4K, hyper-realistic, shallow depth of field.',
    [Scenario.BABY_ONESIE_FLATLAY]: 'Close-up, top-down flat-lay photograph of a plain, soft baby onesie on a clean, light-colored wooden surface. The chest area of the onesie features a solid, vibrant magenta color (#FF00FF) placeholder. The scene is styled with a few cute baby toys. 4K, hyper-realistic.',
    [Scenario.TANK_TOP_FITNESS]: 'Close-up, dynamic fitness photograph of a model\'s torso wearing a plain athletic tank top in a modern gym. The front of the tank top has a solid, vibrant magenta color (#FF00FF) placeholder. The background is slightly blurred gym equipment. 4K, hyper-realistic, tack-sharp focus on the tank top.',
    [Scenario.SOCKS_PAIR]: 'Close-up, top-down flat-lay photograph of a pair of plain socks, neatly arranged on a clean, neutral background. The area for the design on each sock is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic, sharp details.',
    [Scenario.BEANIE_MODEL]: 'Close-up, cozy portrait of a person wearing a plain beanie in a warm, autumnal outdoor setting. The folded part of the beanie has a solid, vibrant magenta color (#FF00FF) placeholder. The background is filled with soft, blurry autumn leaves. 4K, hyper-realistic, tack-sharp focus on the beanie and its texture.',
    [Scenario.APRON_PERSON]: 'Close-up shot of a person\'s torso wearing a plain apron in a rustic, inviting kitchen. The front of the apron has a large solid, vibrant magenta color (#FF00FF) placeholder. The person is engaged in a cooking activity, with hands slightly blurred. 4K, hyper-realistic, tack-sharp focus on the apron.',
    [Scenario.FRAMED_POSTER_LIVING_ROOM]: 'Photograph of a stylish, modern living room with a large, simple black frame hanging on a clean wall above a sofa. The interior of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CAFE_INTERIOR_POSTER]: 'Photograph of a trendy, cozy coffee shop interior. A medium-sized wooden frame is on a brick wall. The inside of the frame is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.STREET_A_FRAME_SIGN]: 'Photograph of a classic A-frame sandwich board sign on a city sidewalk outside a shop. The sign face is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    ...
    [Scenario.MUG_OFFICE_DESK]: 'Photograph of a professional-looking mug on a modern, stylish office desk. The mug has a solid, vibrant magenta color (#FF00FF) placeholder for a design. 4K, hyper-realistic.',
    [Scenario.MUG_CAMPING]: 'Photograph of a rugged enamel mug in a rustic outdoor setting by a campfire. The mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MUGS_PAIR]: 'Photograph of two matching mugs side-by-side on a clean surface. Each mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MUG_WITH_BOOKS]: 'Photograph of a cozy, intellectual scene with a mug next to a stack of books. The mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MUG_KITCHEN_COUNTER]: 'Photograph of a clean, bright shot of a mug on a modern kitchen counter. The mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MUG_HOLIDAY]: 'Photograph of a festive scene with a mug surrounded by warm holiday decorations. The mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.ESPRESSO_CUP_SAUCER]: 'Photograph of a chic, high-end cafe scene featuring a small espresso cup. The cup has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MUG_IN_GIFT_BOX]: 'Photograph of a mug presented elegantly inside an open gift box. The mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MUG_HELD_BY_PERSON]: 'Close-up, lifestyle shot of a person holding a mug with both hands. The mug has a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SERUM_BOTTLE]: 'Photograph of a sleek glass dropper bottle on a clean surface. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.PUMP_BOTTLE]: 'Photograph of a versatile pump bottle for lotions or soaps on a clean bathroom counter. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SQUEEZE_TUBE]: 'Photograph of a soft cosmetic tube for creams or gels. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CANDLE_JAR]: 'Photograph of a cozy scene with a glass candle jar. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.COFFEE_BAG]: 'Photograph of a stand-up coffee bag pouch with a modern aesthetic. The front label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.BEER_BOTTLE]: 'Photograph of a chilled amber glass beer bottle. The label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.HONEY_JAR]: 'Photograph of a rustic glass honey jar with a wooden dipper. The label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SOAP_BAR_WRAP]: 'Photograph of a rustic, handmade bar of soap with a paper wrap. The wrap design area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SPRAY_BOTTLE]: 'Photograph of a clean spray bottle. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_HOLDING_PRODUCT_STREET]: 'Commercial lifestyle photo. A beautiful, stylish woman is holding a generic product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. She is on a vibrant, slightly blurred American city street. 4K, hyper-realistic.',
    [Scenario.WOMAN_STOOL_PRODUCT_LA]: 'Interior lifestyle photo. A stylish woman in a modern Los Angeles living room sits on a stool, holding and looking at a generic product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_COUCH_PRODUCT_LA]: 'Interior lifestyle photo. A stylish woman in a trendy Los Angeles bedroom sits on a couch, pointing at a generic product box placed on a table. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_SOFA_PRODUCT_PARIS]: 'Interior lifestyle photo. An elegant woman on a velvet sofa in a modern Parisian living room points at a generic product box on a coffee table. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_LINGERIE_PRODUCT_SWISS_PARISIAN]: 'Luxury lifestyle photo. An elegant Swiss woman in tasteful lingerie is in a Parisian-style bedroom in Switzerland, pointing to a luxury product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_NIGHTGOWN_PRODUCT_SWISS_PARISIAN]: 'Luxury lifestyle photo. An elegant Swiss woman in a white nightgown and robe is in a Parisian-style bedroom in Switzerland, pointing to a premium product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MOTHER_DAUGHTER_PRODUCT_CAMBRIDGE_ITALIANATE]: 'Heartwarming lifestyle photo. An elegant American woman and her daughter in a trendy Italianate hall in Cambridge, showing awe towards a product box. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_CAMBRIDGE_ITALIANATE]: 'Lifestyle photo. An elegant American woman in a trendy Italianate hall in Cambridge, showing awe towards a product box. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_ZURICH]: 'Commercial photo. A stylish woman presents a product box on Bahnhofstrasse, Zurich. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_GENEVA]: 'Commercial photo. An elegant woman holds a product box by Lake Geneva. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_ZERMATT]: 'Commercial photo. A chic woman showcases a product box in Zermatt. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_BERN]: 'Commercial photo. A chic woman presents a product box in the Old Town of Bern. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_LUCERNE]: 'Commercial photo. An elegant woman holds a product box near the Chapel Bridge in Lucerne. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_LUGANO]: 'Commercial photo. A stylish woman showcases a product box in Lugano. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_ST_MORITZ]: 'Luxury commercial photo. A glamorous woman showcases a product box in St. Moritz. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_INTERLAKEN]: 'Commercial photo. An adventurous woman holds a product box in Interlaken. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_MONTREUX]: 'Commercial photo. An artistic woman presents a product box in Montreux. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_LIVING_ROOM]: 'Lifestyle photo. A beautiful woman holds a product box naturally in a bright, modern living room. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_KITCHEN]: 'Lifestyle photo. A cheerful woman showcases a product box in a sunlit kitchen. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_BEDROOM]: 'Lifestyle photo. An elegant woman presents a product box in a serene bedroom. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_HOME_OFFICE]: 'Lifestyle photo. A professional woman holds a product box in her chic home office. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_BATHROOM]: 'Lifestyle photo. A woman presents a beauty product box in a luxurious bathroom. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_NURSERY]: 'Lifestyle photo. A mother holds a baby product box in a bright nursery. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_LASER_PRODUCT_MODERN_LIVING_ROOM]: 'Lifestyle photo. An elegant woman holds a wooden laser light product in a modern living room. The product has a solid vibrant magenta (#FF00FF) placeholder area. 4K, hyper-realistic.',
    [Scenario.WOMAN_LASER_PRODUCT_SCANDINAVIAN_BEDROOM]: 'Lifestyle photo. A woman showcases a wooden laser light product in a serene, Scandinavian-style bedroom. The product has a solid vibrant magenta (#FF00FF) placeholder area. 4K, hyper-realistic.',
    [Scenario.WOMAN_LASER_PRODUCT_BOHEMIAN_STUDIO]: 'Lifestyle photo. A woman presents a wooden laser light product in an artistic, bohemian-style studio. The product has a solid vibrant magenta (#FF00FF) placeholder area. 4K, hyper-realistic.',
    [Scenario.WOMAN_LASER_PRODUCT_MINIMALIST_OFFICE]: 'Lifestyle photo. A professional woman holds a wooden laser light product in a clean, minimalist home office. The product has a solid vibrant magenta (#FF00FF) placeholder area. 4K, hyper-realistic.',
    [Scenario.WOMAN_LASER_PRODUCT_RUSTIC_DINING_ROOM]: 'Lifestyle photo. A woman holds a wooden laser light product in a warm, rustic dining room. The product has a solid vibrant magenta (#FF00FF) placeholder area. 4K, hyper-realistic.',
    [Scenario.WOMAN_LASER_LAMP_KITCHEN]: 'Interior design photo. An elegant woman pointing to a laser-cut wooden lamp in a luxury kitchen. The lamp shade has a solid vibrant magenta (#FF00FF) placeholder for a design. 4K, hyper-realistic.',
    [Scenario.ICE_CREAM_PINT]: 'Commercial photograph of a paper ice cream pint container. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CHOCOLATE_BAR_WRAPPER]: 'Commercial photograph of a luxury chocolate bar. The wrapper is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.OLIVE_OIL_BOTTLE]: 'Commercial photograph of a glass bottle of olive oil. The label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CHIPS_BAG]: 'Studio photograph of a glossy bag of potato chips. The front design area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.YOGURT_CUP]: 'Commercial photograph of a yogurt cup. The label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.THROW_PILLOW_SOFA]: 'Interior design photograph of a throw pillow on a modern sofa. The entire front face of the pillow is a solid, vibrant magenta color (#FF00FF) placeholder for a pattern or design. 4K, hyper-realistic.',
    [Scenario.DUVET_COVER_BED]: 'Interior design photograph of a bed with a duvet cover. The entire top surface of the duvet is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WALL_CLOCK_LIVING_ROOM]: 'Photograph of a modern, frameless wall clock in a living room. The face of the clock is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SHOWER_CURTAIN_BATHROOM]: 'Photograph of a shower curtain in a clean, modern bathroom. The entire shower curtain is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.BEACH_TOWEL_SAND]: 'Top-down photograph of a beach towel laid out on the sand. The entire towel is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.DRONE_BOX_PACKAGING]: 'Commercial photograph of a sleek, modern box for a high-tech drone. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SMART_SPEAKER_BOX]: 'Commercial photograph of the retail box for a smart speaker. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CAMERA_BOX_PACKAGING]: 'Commercial photograph of the premium packaging for a new digital camera. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.GAMING_MOUSE_BOX]: 'Commercial photograph of the box for a gaming mouse in a dynamic, lit environment. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WEBCAM_BOX_PACKAGING]: 'Commercial photograph of the retail box for a webcam. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.FOLDED_SHIRT_HELD]: 'Close-up photograph of a hand holding a neatly folded plain t-shirt against a natural, outdoor background. The visible area on the shirt is a solid, vibrant magenta color (#FF00FF) placeholder. Professional, vivid natural colors, tack-sharp focus on the shirt, 8K resolution.',
    [Scenario.FOLDED_SHIRT_HELD_CLOSEUP]: 'Extreme close-up, highly realistic outdoor photograph of a folded shirt held in hand on the right side. The shirt has a solid, vibrant magenta (#FF00FF) placeholder area. The logo area is in tack-sharp focus. Green grass, trees, and a blue sky, cinematic lighting, clear details, 8K resolution.',
    [Scenario.WOMAN_HOLDING_TSHIRT_OUTDOORS_CLOSEUP]: 'Extreme close-up, commercial photograph of an elegant woman holding a t-shirt. The placeholder area on the t-shirt is a solid vibrant magenta (#FF00FF). The focus is tack-sharp on the placeholder area, against a backdrop of wide grass and forests. Cinematic composition, highly realistic details, 8K resolution.',
  },
  edit: {
