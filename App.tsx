...
const PROMPTS = {
  base: {
    ...
    [Scenario.COFFEE_MUG]: 'Lifestyle photograph of a person holding a simple, earthy terracotta ceramic coffee mug. The front of the mug has a large, solid, vibrant magenta color (#FF00FF) area as a placeholder for a design. The background is a cozy, blurred cafe setting. The focus is sharp on the mug. 4K, hyper-realistic.',
    [Scenario.COSMETIC_JAR]: 'Luxury product photograph. A premium, minimalist frosted glass cosmetic jar sits on an elegant marble surface. The label area on the jar is a solid, vibrant magenta color (#FF00FF) placeholder. The lighting is soft and sophisticated, creating subtle reflections. 4K, hyper-realistic.',
    [Scenario.BOOK_COVER]: 'Photograph of a realistic hardcover book with a dark green cover, lying on a cozy wooden table, next to a pair of glasses and a cup of tea. The front cover of the book has an area that is a solid, vibrant magenta color (#FF00FF) placeholder. The scene is warm and inviting. 4K, hyper-realistic.',
    [Scenario.WINE_BOTTLE]: 'Commercial photograph of a classic dark green glass wine bottle against a dark, moody background. The label on the bottle is a solid, vibrant magenta color (#FF00FF) placeholder. There are subtle highlights on the glass, giving it a premium look. 4K, hyper-realistic.',
    [Scenario.SHOPPING_BAG]: 'Fashion lifestyle photograph. A stylish person is holding a high-end paper shopping bag in a deep forest green color. The side of the bag facing the camera has a solid, vibrant magenta color (#FF00FF) placeholder. The background is a blurred, upscale retail environment. 4K, hyper-realistic.',
    [Scenario.SODA_CAN]: 'Commercial product shot of a cold, condensation-covered sleek matte silver aluminum soda can. The label area wrapping around the can is a solid, vibrant magenta color (#FF00FF) placeholder. The background is clean and simple, making the can pop. 4K, hyper-realistic.',
    ...
    [Scenario.PILL_BOTTLE]: 'Clean, clinical photograph of a classic amber glass pharmaceutical pill bottle on a plain white surface. The label on the bottle is a solid, vibrant magenta color (#FF00FF) placeholder. The lighting is bright and even, suitable for medical or health products. 4K, hyper-realistic.',
    [Scenario.CEREAL_BOX]: 'Commercial photograph of a recycled cardboard cereal box on a sunny kitchen counter, next to a bowl and a glass of milk. The front of the cereal box is a solid, vibrant magenta color (#FF00FF) placeholder. The scene is bright and cheerful. 4K, hyper-realistic.',
    ...
    [Scenario.SERUM_BOTTLE]: 'Photograph of a sleek dark amber glass dropper bottle on a clean surface. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.PUMP_BOTTLE]: 'Photograph of a versatile white ceramic pump bottle for lotions or soaps on a clean bathroom counter. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SQUEEZE_TUBE]: 'Photograph of a soft, matte pastel green cosmetic tube for creams or gels. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CANDLE_JAR]: 'Photograph of a cozy scene with a smoky gray glass candle jar. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.COFFEE_BAG]: 'Photograph of a natural kraft paper stand-up coffee bag pouch with a modern aesthetic. The front label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    ...
    [Scenario.SOAP_BAR_WRAP]: 'Photograph of a rustic, oatmeal-colored handmade bar of soap with a paper wrap. The wrap design area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SPRAY_BOTTLE]: 'Photograph of a clean, clear glass spray bottle with a metal nozzle. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_HOLDING_PRODUCT_STREET]: 'Commercial lifestyle photo. A beautiful, stylish woman is holding a simple, eco-friendly kraft paper product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. She is on a vibrant, slightly blurred American city street. 4K, hyper-realistic.',
    [Scenario.WOMAN_STOOL_PRODUCT_LA]: 'Interior lifestyle photo. A stylish woman in a modern Los Angeles living room sits on a stool, holding and looking at a stylish, matte olive green product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_COUCH_PRODUCT_LA]: 'Interior lifestyle photo. A stylish woman in a trendy Los Angeles bedroom sits on a couch, pointing at a trendy, muted terracotta product box placed on a table. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_SOFA_PRODUCT_PARIS]: 'Interior lifestyle photo. An elegant woman on a velvet sofa in a modern Parisian living room points at an elegant, deep navy blue product box on a coffee table. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_LINGERIE_PRODUCT_SWISS_PARISIAN]: 'Luxury lifestyle photo. An elegant Swiss woman in tasteful lingerie is in a Parisian-style bedroom in Switzerland, pointing to a luxury, soft cream-colored product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_NIGHTGOWN_PRODUCT_SWISS_PARISIAN]: 'Luxury lifestyle photo. An elegant Swiss woman in a white nightgown and robe is in a Parisian-style bedroom in Switzerland, pointing to a premium, dusty rose colored product box. The front of the box is a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.MOTHER_DAUGHTER_PRODUCT_CAMBRIDGE_ITALIANATE]: 'Heartwarming lifestyle photo. An elegant American woman and her daughter in a trendy Italianate hall in Cambridge, showing awe towards a charming, light gray product box. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_CAMBRIDGE_ITALIANATE]: 'Lifestyle photo. An elegant American woman in a trendy Italianate hall in Cambridge, showing awe towards a sophisticated, charcoal gray product box. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_ZURICH]: 'Commercial photo. A stylish woman presents a forest green product box on Bahnhofstrasse, Zurich. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_GENEVA]: 'Commercial photo. An elegant woman holds a sandy beige product box by Lake Geneva. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_ZERMATT]: 'Commercial photo. A chic woman showcases a sky blue product box in Zermatt. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_BERN]: 'Commercial photo. A chic woman presents an earthy brown product box in the Old Town of Bern. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_LUCERNE]: 'Commercial photo. An elegant woman holds a stone gray product box near the Chapel Bridge in Lucerne. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_LUGANO]: 'Commercial photo. A stylish woman showcases a burgundy-colored product box in Lugano. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_ST_MORITZ]: 'Luxury commercial photo. A glamorous woman showcases a gold-accented product box in St. Moritz. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_INTERLAKEN]: 'Commercial photo. An adventurous woman holds a slate blue product box in Interlaken. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_MONTREUX]: 'Commercial photo. An artistic woman presents a lavender-colored product box in Montreux. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_LIVING_ROOM]: 'Lifestyle photo. A beautiful woman holds a light beige product box naturally in a bright, modern living room. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_KITCHEN]: 'Lifestyle photo. A cheerful woman showcases a mint green product box in a sunlit kitchen. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_BEDROOM]: 'Lifestyle photo. An elegant woman presents a soft pink product box in a serene bedroom. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_HOME_OFFICE]: 'Lifestyle photo. A professional woman holds a professional navy blue product box in her chic home office. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_BATHROOM]: 'Lifestyle photo. A woman presents a seafoam green beauty product box in a luxurious bathroom. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WOMAN_PRODUCT_NURSERY]: 'Lifestyle photo. A mother holds a pastel yellow baby product box in a bright nursery. The box has a solid vibrant magenta (#FF00FF) placeholder. 4K, hyper-realistic.',
    ...
    [Scenario.ICE_CREAM_PINT]: 'Commercial photograph of a simple, off-white paper ice cream pint container. The label area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CHOCOLATE_BAR_WRAPPER]: 'Commercial photograph of a luxury chocolate bar in a dark brown paper wrapper. The wrapper has an area that is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.OLIVE_OIL_BOTTLE]: 'Commercial photograph of a dark green glass bottle of olive oil. The label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CHIPS_BAG]: 'Studio photograph of a matte-finish, earthy-toned bag of potato chips. The front design area is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.YOGURT_CUP]: 'Commercial photograph of a simple white yogurt cup. The label is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    ...
    [Scenario.WALL_CLOCK_LIVING_ROOM]: 'Photograph of a modern, frameless wall clock with a light wood face in a living room. The face of the clock is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    ...
    [Scenario.DRONE_BOX_PACKAGING]: 'Commercial photograph of a sleek, matte black box for a high-tech drone. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.SMART_SPEAKER_BOX]: 'Commercial photograph of the retail box in a clean, soft grey color for a smart speaker. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.CAMERA_BOX_PACKAGING]: 'Commercial photograph of the premium, dark charcoal packaging for a new digital camera. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.GAMING_MOUSE_BOX]: 'Commercial photograph of the box for a gaming mouse in a dynamic, lit environment. The box is dark with cyan accents, and the front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
    [Scenario.WEBCAM_BOX_PACKAGING]: 'Commercial photograph of the retail box in a simple, professional blue for a webcam. The front of the box is a solid, vibrant magenta color (#FF00FF) placeholder. 4K, hyper-realistic.',
