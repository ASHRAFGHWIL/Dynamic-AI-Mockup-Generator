...
const SCENARIO_OPTIONS: ScenarioOption[] = [
  ...
  {
    id: Scenario.WOMAN_DINING_PRODUCT_CAMBRIDGE_ITALIANATE,
    title: 'Woman with Product (Cambridge Dining)',
    description: 'An elegant American woman in a contemporary Italianate dining room in Cambridge, England, pointing to your product on a table.',
    image: 'https://picsum.photos/seed/productcambridgedining/400/300',
    requiresDesign: 'product',
    subcategory: 'subcategoryProductHomeLifestyle',
  },
  {
...
const PROMPTS = {
  base: {
    ...
    [Scenario.WOMAN_DINING_PRODUCT_CAMBRIDGE_ITALIANATE]: 'DSLR photograph, stylish marketing advertisement. A beautiful, elegant, blue-eyed American woman is in a contemporary Italianate Cambridge dining room. She sits on a velvet-upholstered armchair, looking at a simple, solid magenta (#FF00FF) cube on a table, and points at it with her finger, smiling a feminine smile. The cube represents a product no taller than 25cm. To highlight the product, the background is beautifully blurred (bokeh) and it is a front-facing shot. The portrait ratio is cinematic, with a vertical aspect ratio. 4K, hyper-realistic.',
