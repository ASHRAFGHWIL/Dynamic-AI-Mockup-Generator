...
const PROMPTS = {
  base: {
    ...
    [Scenario.WOMAN_LASER_LAMP_LIVING_ROOM_ADVERTISEMENT]: 'A glamorous and elegant American woman in her late twenties stands in a luxurious, contemporary living room with bright natural light and luxurious finishes. She smiles warmly, pointing to a solid, vibrant magenta color (#FF00FF) shape suspended above the island table. This shape is a placeholder for a beautifully designed lamp. The scene is designed as a luxury advertisement, with a cinematic composition, ultra-realistic 8K quality, shallow depth of field, professional product photography style, and warm color gradation.',
    [Scenario.WOMAN_LASER_LAMP_COTSWOLDS]: 'A glamorous and elegant British country woman in her late twenties stands in a "vintage country house" foyer with bright natural light and "vintage country" finishes. Behind the window, a charming Cotswolds village with its iconic honey-colored stone cottages can be seen. She smiles warmly, pointing up to a solid, vibrant magenta color (#FF00FF) shape suspended from the ceiling. This shape is a placeholder for a beautifully designed lamp. The scene is designed as a luxury advertisement, with a cinematic composition, ultra-realistic 8K quality, shallow depth of field, professional product photography style, and warm color gradation.',
    [Scenario.WOMAN_LASER_LAMP_LAKE_DISTRICT]: 'A glamorous and elegant British country woman in her late twenties stands in a "vintage country house" foyer with bright natural light and "vintage country" finishes. Behind the window, the serene and iconic landscape of the Lake District, with a glistening lake and rolling hills, can be seen. She smiles warmly, pointing up to a solid, vibrant magenta color (#FF00FF) shape suspended from the ceiling. This shape is a placeholder for a beautifully designed lamp. The scene is designed as a luxury advertisement, with a cinematic composition, ultra-realistic 8K quality, shallow depth of field, professional product photography style, and warm color gradation.',
    [Scenario.WOMAN_LASER_LAMP_DOVER_CLIFFS]: 'A glamorous and elegant British country woman in her late twenties stands in a "vintage country house" foyer with bright natural light and "vintage country" finishes. Behind the window, the iconic and dramatic White Cliffs of Dover can be seen. She smiles warmly, pointing up to a solid, vibrant magenta color (#FF00FF) shape suspended from the ceiling. This shape is a placeholder for a beautifully designed lamp. The scene is designed as a luxury advertisement, with a cinematic composition, ultra-realistic 8K quality, shallow depth of field, professional product photography style, and warm color gradation.',
    [Scenario.WOMAN_LASER_LAMP_STONEHENGE]: 'A glamorous and elegant British country woman in her late twenties stands in a "vintage country house" foyer with bright natural light and "vintage country" finishes. Behind the window, the ancient and iconic monoliths of Stonehenge can be seen in the distance across the Salisbury Plain. She smiles warmly, pointing up to a solid, vibrant magenta color (#FF00FF) shape suspended from the ceiling. This shape is a placeholder for a beautifully designed lamp. The scene is designed as a luxury advertisement, with a cinematic composition, ultra-realistic 8K quality, shallow depth of field, professional product photography style, and warm color gradation.',
    [Scenario.WOMAN_LASER_LAMP_SCOTTISH_HIGHLANDS]: 'A glamorous and elegant British country woman in her late twenties stands in a "vintage country house" foyer with bright natural light and "vintage country" finishes. Behind the window, the rugged, iconic landscape of the Scottish Highlands, with a misty loch and mountains, can be seen. She smiles warmly, pointing up to a solid, vibrant magenta color (#FF00FF) shape suspended from the ceiling. This shape is a placeholder for a beautifully designed lamp. The scene is designed as a luxury advertisement, with a cinematic composition, ultra-realistic 8K quality, shallow depth of field, professional product photography style, and warm color gradation.',
...
const App: React.FC = () => {
  ...
  const SCENARIO_OPTIONS: ScenarioOption[] = useMemo(() => [
    ...
    { id: Scenario.WOMAN_LASER_LAMP_LIVING_ROOM_ADVERTISEMENT, title: t('WOMAN_LASER_LAMP_LIVING_ROOM_ADVERTISEMENT_title'), description: t('WOMAN_LASER_LAMP_LIVING_ROOM_ADVERTISEMENT_description'), image: '/scenarios/WOMAN_LASER_LAMP_LIVING_ROOM_ADVERTISEMENT.jpg', requiresDesign: 'chandelier', subcategory: 'general' },
    { id: Scenario.WOMAN_LASER_LAMP_COTSWOLDS, title: t('WOMAN_LASER_LAMP_COTSWOLDS_title'), description: t('WOMAN_LASER_LAMP_COTSWOLDS_description'), image: '/scenarios/WOMAN_LASER_LAMP_COTSWOLDS.jpg', requiresDesign: 'chandelier', subcategory: 'general' },
    { id: Scenario.WOMAN_LASER_LAMP_LAKE_DISTRICT, title: t('WOMAN_LASER_LAMP_LAKE_DISTRICT_title'), description: t('WOMAN_LASER_LAMP_LAKE_DISTRICT_description'), image: '/scenarios/WOMAN_LASER_LAMP_LAKE_DISTRICT.jpg', requiresDesign: 'chandelier', subcategory: 'general' },
    { id: Scenario.WOMAN_LASER_LAMP_DOVER_CLIFFS, title: t('WOMAN_LASER_LAMP_DOVER_CLIFFS_title'), description: t('WOMAN_LASER_LAMP_DOVER_CLIFFS_description'), image: '/scenarios/WOMAN_LASER_LAMP_DOVER_CLIFFS.jpg', requiresDesign: 'chandelier', subcategory: 'general' },
    { id: Scenario.WOMAN_LASER_LAMP_STONEHENGE, title: t('WOMAN_LASER_LAMP_STONEHENGE_title'), description: t('WOMAN_LASER_LAMP_STONEHENGE_description'), image: '/scenarios/WOMAN_LASER_LAMP_STONEHENGE.jpg', requiresDesign: 'chandelier', subcategory: 'general' },
    { id: Scenario.WOMAN_LASER_LAMP_SCOTTISH_HIGHLANDS, title: t('WOMAN_LASER_LAMP_SCOTTISH_HIGHLANDS_title'), description: t('WOMAN_LASER_LAMP_SCOTTISH_HIGHLANDS_description'), image: '/scenarios/WOMAN_LASER_LAMP_SCOTTISH_HIGHLANDS.jpg', requiresDesign: 'chandelier', subcategory: 'general' },
