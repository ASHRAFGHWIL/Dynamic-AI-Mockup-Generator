...
const PROMPTS = {
  base: {
    ...
    [Scenario.SUBWAY_AD]: 'Photograph of a modern, clean subway station platform. On the tiled wall, there is a large, backlit advertising panel. The panel is glowing and displays a solid, vibrant magenta color (#FF00FF) as a placeholder. A few blurred commuters are waiting in the background. The lighting is fluorescent and even. 4K, hyper-realistic, sharp focus on the ad panel.',
