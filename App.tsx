...
const PROMPTS = {
  base: {
    ...
    [Scenario.FOLDED_SHIRT_HELD_CLOSEUP]: 'Close-up, 8K resolution DSLR photograph. A hand holds a neatly folded shirt on the right side. The visible portion of the folded shirt has a large, solid magenta (#FF00FF) rectangle as a placeholder for a logo. The background is a highly realistic outdoor scene with green grass, trees, and a blue sky. The scene has vivid natural colors and cinematic lighting. Tack-sharp focus on the shirt and placeholder.',
    [Scenario.WOMAN_HOLDING_TSHIRT_OUTDOORS_CLOSEUP]: 'Close-up, 8K resolution professional outdoor advertising and commercial photography. A beautiful, elegant woman holds up a plain t-shirt, showing the front to the camera. On the front of the t-shirt is a large, solid magenta (#FF00FF) rectangle as a placeholder for a printed logo. The focus is tack-sharp on the magenta placeholder. The background is a wide expanse of green grass and forests, beautifully blurred (bokeh). Cinematic composition with highly realistic details.',
...
const App: React.FC = () => {
  ...
  const SCENARIO_OPTIONS: ScenarioOption[] = useMemo(() => [
    ...
    {
      id: Scenario.FOLDED_SHIRT_HELD_CLOSEUP,
      title: t('FOLDED_SHIRT_HELD_CLOSEUP_title'),
      description: t('FOLDED_SHIRT_HELD_CLOSEUP_description'),
      image: 'https://picsum.photos/seed/foldedshirtcloseup/400/300',
      requiresDesign: 'apparel',
      subcategory: 'subcategoryTops',
    },
    {
      id: Scenario.WOMAN_HOLDING_TSHIRT_OUTDOORS_CLOSEUP,
      title: t('WOMAN_HOLDING_TSHIRT_OUTDOORS_CLOSEUP_title'),
      description: t('WOMAN_HOLDING_TSHIRT_OUTDOORS_CLOSEUP_description'),
      image: 'https://picsum.photos/seed/womantshirtcloseup/400/300',
      requiresDesign: 'apparel',
      subcategory: 'subcategoryTops',
    },
    {
